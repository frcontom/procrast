        ...
        {STAGES.map((stage, i) => {
          ...
          return (
            <div key={stage.img} className="flex flex-col items-center gap-1 flex-1">
              <div className={`relative w-[120px] h-[120px] rounded-xl overflow-hidden border transition-all duration-500 ${isCurrent ? 'border-accent/20 ring-1 ring-accent/10 shadow-lg shadow-accent/10' : unlocked ? 'border-white/[0.04]' : 'border-white/[0.02]'}`}
