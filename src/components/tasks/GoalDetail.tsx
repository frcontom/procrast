...
export function GoalDetail({ goal, subtasks, onSubtaskToggle, onSubtaskDelete, onAddSubtask, onEditSubtask, onSetDependency, onStartPomodoro, onImportSubtasks }: Props) {
  const user = useUser()
  ...
  return (
    <div className="space-y-4">
      ...
      <div id="tk-subtasks" className="bg-card rounded-xl border border-white/10 p-4">
        ...
        <SubtaskList subtasks={subtasks} onToggle={onSubtaskToggle} onDelete={onSubtaskDelete} onEdit={setEditingSubtask} onSetDependency={onSetDependency} onStartPomodoro={onStartPomodoro} />
      </div>
