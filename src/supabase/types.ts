...
export interface TaskSubtask { id: string; user_id: string; goal_id: string; name: string; description: string; estimated_minutes: number; completed_minutes: number; status: 'pending' | 'in_progress' | 'completed'; difficulty: 'easy' | 'normal' | 'hard'; depends_on: string | null; sort_order: number; collapsed: boolean; created_at: string }
export interface TaskSubtaskInsert { user_id: string; goal_id: string; name: string; description?: string; estimated_minutes?: number; completed_minutes?: number; status?: 'pending' | 'in_progress' | 'completed'; difficulty?: 'easy' | 'normal' | 'hard'; depends_on?: string | null; sort_order?: number; collapsed?: boolean }
export interface TaskSubtaskUpdate { name?: string; description?: string; estimated_minutes?: number; completed_minutes?: number; status?: 'pending' | 'in_progress' | 'completed'; difficulty?: 'easy' | 'normal' | 'hard'; depends_on?: string | null; sort_order?: number; collapsed?: boolean }
...
export interface Habit { id: string; user_id: string; name: string; icon: string; color: string; month_key: string; is_primary: boolean; is_starred: boolean; sort_order: number; created_at: string }
export interface HabitInsert { user_id: string; name: string; icon?: string; color?: string; month_key: string; is_primary?: boolean; is_starred?: boolean; sort_order?: number }
export interface HabitUpdate { name?: string; icon?: string; color?: string; month_key?: string; is_primary?: boolean; is_starred?: boolean; sort_order?: number }
